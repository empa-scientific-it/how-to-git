...
4. Start with a template: Leave it set to _No template_ (default)

5. **Uncheck** the option _Initialize this repository with a README_

6. Add `.gitignore`: Leave it set to _No .gitignore_ (default)

7. Choose a license: Leave it set to _No license_ (default)
