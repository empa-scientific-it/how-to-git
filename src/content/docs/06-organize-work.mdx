...
We previously discussed how to work with [issues](./03-plan-work.mdx) and [branches](./04-parallel-topics.mdx).
...
This makes it clear which issue the branch is addressing.
