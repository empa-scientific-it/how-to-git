...
- **Commit directly** to the current :term[branch] or create a **new branch** for this commit and start a :term[pull request]: Branching out will be described further [down](#branching-out-topics).
