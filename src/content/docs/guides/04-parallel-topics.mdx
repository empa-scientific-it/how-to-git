...
For most beginners, merging `main` into your branch is the recommended approach, while rebasing is a useful technique to learn as you become more familiar with Git.
