...
<Tabs syncKey="option">
  <TabItem label="GitHub">
    ...
    We will focus on the privately owned repositories.
  ...
  <TabItem label="GitLab">
    ...
    We will focus on privately managed repositories.
    To invite collaborators, you can open the project on GitLab, go `Manage` > `Members` on the left-hand side menu, and invite collaborators by their GitLab username or email.
