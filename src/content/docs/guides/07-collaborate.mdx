...
<Tabs syncKey="option">
  ...
  <TabItem label="GitLab">
    ...
    The fact that a repository can be private or public already influences its basic access management, as discussed in the [Public vs Private repositories](../repository/#public-vs-private-repositories) section, so we will not repeat it here.
    However, there are advanced features that allow you to manage access to the repository in more detail.
