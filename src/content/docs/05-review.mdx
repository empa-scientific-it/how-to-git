...
For that a Pull request can be started.
After the Pull request is started, one can choose a review from someone specific.
It makes more sense, if the person to review it is not involved in that specific topic, but is close to the it.

[TODO explanation how to do]
To create a PR review, you must be in your branch.
