...
### 2. Publishing analysis code with a paper

You created a script for data evaluation and want to publish it openly with your paper.
...
<Aside type="tip" title="No code knowledge required">
  ...
  Instead, we will use only text files, since code is ultimately just text.
</Aside>
